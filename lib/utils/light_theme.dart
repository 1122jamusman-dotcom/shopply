...
ThemeData lightTheme = ThemeData.light().copyWith(
  ...
  textTheme: ThemeData.light().textTheme.copyWith(
    headlineLarge: GoogleFonts.poppins(color: Colors.black, fontSize: 26.sp),
    titleMedium: GoogleFonts.poppins(color: Colors.black, fontSize: 20.sp),
    titleSmall: GoogleFonts.poppins(color: Colors.white, fontSize: 16.sp),
    bodyLarge: GoogleFonts.poppins(color: Color(0xff9D9D9D), fontSize: 16.sp),
    bodyMedium: GoogleFonts.poppins(color: Color(0xff9D9D9D), fontSize: 14.sp),
  ),
);
